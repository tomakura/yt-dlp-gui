...
export const translations = {
  ja: {
    ...
    progressDownloadFinished: 'ダウンロード完了',
    progressPostprocessing: '後処理',
    progressCleaningUp: 'クリーンアップ中',
    progressCurrentStep: '現在',
    progressIndeterminate: '処理を継続しています',
    progressStepPreparing: '準備',
    progressStepDownloading: '取得',
    progressStepPostprocessing: '後処理',
    progressStepCleanup: '整理',
    progressStepStarted: '{step}を開始',
    progressStepFinished: '{step}が完了',
    progressMerging: '映像と音声を結合中',
    progressConvertingVideo: 'ffmpegで動画を変換中',
    progressConvertingAudio: 'ffmpegで音声を変換中',
    progressEmbeddingThumbnail: 'サムネイルを埋め込み中',
    progressEmbeddingMetadata: 'メタデータを書き込み中',
    progressEmbeddingSubtitles: '字幕を埋め込み中',
    progressFinalizing: 'ファイルを確定中',
  ...
  en: {
    ...
    progressPostprocessing: 'Post-processing',
    progressCleaningUp: 'Cleaning up',
    progressCurrentStep: 'Current',
    progressIndeterminate: 'Still working',
    progressStepPreparing: 'Prepare',
    progressStepDownloading: 'Download',
    progressStepPostprocessing: 'Process',
    progressStepCleanup: 'Clean up',
    progressStepStarted: 'Started {step}',
    progressStepFinished: 'Finished {step}',
    progressMerging: 'Merging video and audio',
    progressConvertingVideo: 'Converting video with ffmpeg',
    progressConvertingAudio: 'Converting audio with ffmpeg',
    progressEmbeddingThumbnail: 'Embedding thumbnail',
    progressEmbeddingMetadata: 'Writing metadata',
    progressEmbeddingSubtitles: 'Embedding subtitles',
    progressFinalizing: 'Finalizing file',
